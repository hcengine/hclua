    ...
    for (elem, index) in iterator.zip(1..) {
        ...
        match size {
            ...
            1 => {
                ...
                unsafe { sys::lua_insert(lua, -2) }
                unsafe { sys::lua_settable(lua, -3) }
            },
            2 => unsafe { sys::lua_settable(lua, -3) },
            _ => unreachable!()
        }
    }
                          ...
                          where V: LuaPush, I: Iterator<Item=V>
{
    ...
    unsafe { sys::lua_createtable(lua, 0, nrec as i32) };
