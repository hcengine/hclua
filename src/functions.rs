                      ...
                      R: LuaPush + 'static
        {
            fn push_to_lua(self, lua: *mut lua_State) -> i32 {
                unsafe {
                    ...
                    let wrapper: extern "C" fn(*mut sys::lua_State) -> libc::c_int = wrapper::<Self, _, R>;
                      ...
                      R: LuaPush + 'static
        {
            fn push_to_lua(self, lua: *mut lua_State) -> i32 {
                unsafe {
                    ...
                    // pushing wrapper as a closure
                    let wrapper: extern fn(*mut sys::lua_State) -> libc::c_int = wrapper::<Self, _, R>;
                    sys::lua_pushcclosure(lua, wrapper, 1);
                    1
                }
            }
...
extern "C" fn wrapper<T, P, R>(lua: *mut sys::lua_State) -> libc::c_int
